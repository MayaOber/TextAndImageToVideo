...
parser.add_argument('--img',required=False,default=os.path.join("assets", "image.jpg"),help="image file path")
parser.add_argument('--img-prompt',required=False)
parser.add_argument('--audio',required=False,default=os.path.join("assets", "audio.mp3"),help="audio file path")
parser.add_argument('--audio-text',required=False)
parser.add_argument('--voice-id',required=False)
parser.add_argument("--ar", required=False,default="1:1",choices=["1:1", "9:16", "16:9"])
